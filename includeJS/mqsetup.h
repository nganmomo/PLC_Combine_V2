...
<h3 style='display:inline'>For communcation between two PLC module, set master and slave in the same ECODD</h3><br>\
...
<br>\
<h3 style='display:inline'>MQTT PROTOCOL:</h3><br>\
...
<button type='button' id='upl' onclick='Uploadsetup('MQSU')' style='margin-left:700px'>Upload setup</button><br>\
...
<h3 id='uph'>When all input is complete, press the HARDWARE RESET button to make it effective.</h3>\
<style>input{\
